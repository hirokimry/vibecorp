#!/bin/bash
# test_audit_security_buffer.sh — Issue #439: audit-security が buffer worktree 経由で書き込むことを検証
# 使い方: bash tests/test_audit_security_buffer.sh
...
# --- テスト3: CISO プロンプトに BUFFER_DIR 注入 ---
echo ""
...
assert_file_contains '書込先が ${BUFFER_DIR}/.claude/knowledge/security/audit-log/ である' "$SKILL_FILE" '${BUFFER_DIR}/.claude/knowledge/security/audit-log'
