...
assert_file_contains "兄弟スキル: /vibecorp:docs-rewrite-all" "$SKILL_MD" "/vibecorp:docs-rewrite-all"
assert_file_contains "兄弟スキル: /vibecorp:prompts-rewrite-all" "$SKILL_MD" "/vibecorp:prompts-rewrite-all"
