...
|---|---|---|---|
| **minimal** | /review, /review-loop, /pr-review-loop, /pr, /commit, /issue, /ship, /plan, /branch, /plan-review-loop | protect-files | 個人〜小規模 |
...
| `/pr` | PR 作成 + auto-merge 設定 |
| `/pr-review-loop` | PR のレビュー指摘修正ループ（マージは auto-merge に委ねる） |
