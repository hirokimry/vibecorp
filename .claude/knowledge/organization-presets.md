...
- skills: minimal + /review-to-rules, /sync-check, /sync-edit
- hooks: minimal + review-to-rules-gate, sync-gate
- docs/: minimal と同じ（プレースホルダー生成済み）
...
- agents: C-suite全員（CTO, CPO, CFO, CLO, CISO）+ SM + 分析員（accounting, legal, security）
- skills: standard + （拡張スキル）
